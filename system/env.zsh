...
export PATH="/usr/local/share/python:/opt/local/bin:/opt/local/sbin:/usr/local/opt/coreutils/libexec/gnubin:$ZSH/bin:$ZSH/bin/private:/usr/local/bin:/usr/local/sbin:storm:$PATH"
